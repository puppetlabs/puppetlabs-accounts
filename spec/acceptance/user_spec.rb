...
describe 'accounts::user define', :unless => UNSUPPORTED_PLATFORMS.include?(fact("osfamily")) do
  describe 'main tests' do
    describe user('hunner') do
        ...
        pp = <<-EOS
          ...
          accounts::user { 'hunner':
            ...
            sshkeys              => [
              ...
              'from="myhost.example.com,192.168.1.1" ssh-rsa  vagrant2',
            ],
          }
        EOS
      ...
      it("should have authorized_key", :unless => default['platform'].match(/solaris-10/)) {
        should have_authorized_key 'ssh-rsa  vagrant'
        should have_authorized_key 'from="myhost.example.com,192.168.1.1" ssh-rsa  vagrant2'
      }
    end
